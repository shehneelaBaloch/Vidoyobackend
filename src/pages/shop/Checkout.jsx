...
const Checkout = () => {
  ...
  const validateForm = () => {
    ...
    const gmailRegex = /^[^\s@]+@gmail\.com$/; // Email must end with @gmail.com
    const phoneRegex = /^03\d{9}$/; // Pakistani number format (03XXXXXXXXX)
  ...
  const handleOrderSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://vidoyobackend.vercel.app/api/order', {
        method: 'POST',
        headers: {
